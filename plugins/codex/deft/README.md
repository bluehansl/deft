...
| `deft:multi-round` | **여러 AI가 N라운드 양방향으로 토론·합의 도달** 하는 멀티턴 회의. 기본 워커 3명 — 주제 맞춤 페르소나 배정 (`codex-1.12.0+`). 메시지 버스(브로드캐스트 보드 + 노크) 기반 — pane 시각화 + 자동 깨우기. [상세 가이드](skills/multi-round/GUIDE.md) |
